        ...
        <div class="content-cad-1">
            ...
            <div class="content-cad-2">
                <form class="forms" action="cadastro_2.php" method="GET" autocomplete="off">
                    ...
                    <br />
                    <div class="imagem">
                        <img src="https://tinypic.host/images/2023/03/16/galimg.png" alt="galimg.png" id="imgPhoto" />
                    </div>
                    ...
                    <input id="nome" type="text" name="nome" placeholder="Digite seu nome" required autocomplete="off"
                        class="incad" />
                    <br />
                    ...
                    <input type="email" name="email" id="email" placeholder="nomeexemplo@frontallusa.com" required
                    ...
                    <div class="caixa-mostrar-confirmar">
                        <input type="password" name="confirmar-senha" placeholder="Digite sua senha"
                            id="confirmar-senha" required class="incad" />
                        <span class="mostrar-senha">
                    ...
                    <input type="text" id="phone" name="phone" onkeypress="mask(this, mphone);"
                        onblur="mask(this, mphone);" class="incad" autocomplete="off" placeholder="(99) 99999-9999"
