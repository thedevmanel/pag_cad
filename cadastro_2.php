<!-- <?php
		...
		$select_query = "SELECT `email` FROM $tabela WHERE `email` = '$email'";
		...
		if (($select) && ($select->num_rows != 0)) {
			while ($array = mysqli_fetch_array($select)) {
				...
				if ($detect_email == $email) {
					...
					echo 'alert("Esse login já existe");window.location.href="http://localhost//pag_cad/cadastro.php";</script>';
				}
			}
		} else {
		}
                ...
                <form class="forms" action="php/inserir_dados.php" method="POST" autocomplete="off">
                    ...
                    <div class="cradio">
                        ...
                        <label for="frontall" class="botao">
                            <img src="https://tinypic.host/images/2023/03/16/Logo-Frontallcolorido.png" alt="Frontall"
                                class="image-choice-frontall" />
                        </label>
                        <input id="balance" type="radio" name="empresa" value="Balance" />
                        <label for="balance" class="botao">
                            <img src="https://tinypic.host/images/2023/03/16/balancelogo.png" alt="balancelogo.png"
                                class="image-choice-balance" />
                        </label>
                    ...
                    <div id="botoes-funcoes">
                        <div id="conteiner-select-balance">
                            <input type="text" id="new-select-input-balance" name="funcao-balance"
                                placeholder="Selecione o Cargo" onfocus="selectBalance(0)" onblur="selectBalance(1)" />
