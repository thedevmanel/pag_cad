...
<body>
    <div class="header">
        <!-- PRIMEIRA CAIXA -->
        <div class="imgtitulo">
            <img src="https://tinypic.host/images/2023/03/16/Frontall-HRbranco.png" alt="Frontall-HRbranco.png"
                class="titulo" />
        </div>
    </div>
    <div class="container-edit">
        <div class="content-edit-1">
            <img src="Imagens/Wall_Post.svg" class="image-edit"
                alt="Uma pessoas do gênero feminino editando suas Informações" />

            <div class="content-edit-2">
                <form action="php/update_edit.php" class="forms" method="POST">
                    <br />
                    <h2> EDIÇÃO </h2> <br />
                    <div class="container-edit-inputs">
                        <div class="content-edit-3">
                            ...
                            <br /> <input type="text" name="nome" id="nome" class="inedition" autocomplete="off"
                                value="<?php echo "$nome"; ?>" required placeholder="Digite seu nome" />
                            <br /><br />
                            <label for="email" class="title-input"> email: <span class="asterisco"> * </span> </label>
                            <br /> <input type="email" name="email" id="email" class="inedition-big" autocomplete="off"
                                value="<?php echo "$email"; ?>" required placeholder="nomeexemplo@frontallusa.com" />
                            <br /><br />
                            <label for="senha" class="title-input"> senha: </label>
                            <br /> <input type="password" name="senha" id="senha" class="inedition-password"
                                autocomplete="off" value="" placeholder="Senha não obrigatoria" />
                            <br /><br />

                            <label for="telefone" class="title-input"> telefone: <span class="asterisco"> * </span>
                            </label>
                            <br /> <input type="text" name="telefone" id="telefone" class="inedition" autocomplete="off"
                                value="<?php echo "$telefone"; ?>" onkeypress="mask(this, mphone);"
                                onblur="mask(this, mphone);" required placeholder="(99) 99999-9999" maxlength="15" />
                            <br /><br />
                            <label for="endereco" class="title-input"> endereço: <span class="asterisco"> * </span>
                            </label>
                            <br /> <input type="text" name="endereco" id="endereco" class="inedition-big"
                                autocomplete="off" value="<?php echo "$endereco"; ?>" required
                            ...
                            <div class="cradio-edit">
                                ...
                                <label for="frontall" class="botao">
                                    <img src="https://tinypic.host/images/2023/03/16/Logo-Frontallcolorido.png"
                                        alt="Logo-Frontallcolorido.png" class="image-choice-frontall" />
                                </label>
                            ...
                            <div id="select-frontall">
                                <div id="container-box-frontall">
                                    <input type="text" id="edicao-select-frontall" name="funcao-frontall"
                                        placeholder="Selecione o Cargo" onfocus="selectFrontall(0)"
                                        onblur="selectFrontall(1)" autocomplete="off" />
                                    <div id="escolhas-select-frontall">
                                        <div class="dados-select-frontall" id="dados-frontall1"
                                            onmousedown="dadosFrontall(1)"> CEO </div>
                                        <div class="dados-select-frontall" id="dados-frontall2"
                                            onmousedown="dadosFrontall(2)"> Executive VP </div>
                                        <div class="dados-select-frontall" id="dados-frontall3"
                                            onmousedown="dadosFrontall(3)"> ADM/Finance </div>
                                        <div class="dados-select-frontall" id="dados-frontall4"
                                            onmousedown="dadosFrontall(4)"> Recruitment </div>
                                        <div class="dados-select-frontall" id="dados-frontall5"
                                            onmousedown="dadosFrontall(5)"> People and Culture </div>
                                        <div class="dados-select-frontall" id="dados-frontall6"
                                            onmousedown="dadosFrontall(6)"> Marketing </div>
                                        <div class="dados-select-frontall" id="dados-frontall7"
                                            onmousedown="dadosFrontall(7)"> Sales </div>
                                        <div class="dados-select-frontall" id="dados-frontall8"
                                            onmousedown="dadosFrontall(8)"> Custumer Device </div>
                                        <div class="dados-select-frontall" id="dados-frontall9"
                                            onmousedown="dadosFrontall(9)"> IT </div>
                                    </div>
                                </div>
                            </div>

                            <div id="select-balance">
                                <div id="container-box-balance">
                                    <input type="text" id="edicao-select-balance" name="funcao-balance"
                                        placeholder="Selecione o Cargo" onfocus="selectBalance(0)"
                                        onblur="selectBalance(1)" autocomplete="off" />
                                    <div id="escolhas-select-balance">
                                        <div class="dados-select-balance" id="dados-balance1"
                                            onmousedown="dadosBalance(1)"> Frontend </div>
                                        <div class="dados-select-balance" id="dados-balance2"
                                            onmousedown="dadosBalance(2)"> Backend </div>
                                        <div class="dados-select-balance" id="dados-balance3"
                                            onmousedown="dadosBalance(3)"> BA </div>
                                        <div class="dados-select-balance" id="dados-balance4"
                                            onmousedown="dadosBalance(4)"> QA </div>
                                        <div class="dados-select-balance" id="dados-balance5"
                                            onmousedown="dadosBalance(5)"> UI/UX </div>
                                    </div>
                                </div>
                            </div>

                            <div class="cradio-edit" id="funcao-edicao"></div>
                        ...
                        <div class="content-edit-4">
                            ...
                            <br />
                            <input type="text" name="cpf" id="cpf" class="inedition" autocomplete="off"
                                value="<?php echo $cpf; ?>" required placeholder="000.000.000-00" maxlength="14" />
                            <br /><br />

                            <label for="data_nascimento" class="title-input"> data de nascimento: <span
                                    class="asterisco"> * </span> </label> <br />
                            <input type="text" name="data_nascimento" id="data_nascimento" class="inedition"
                                autocomplete="off" value="<?php echo $data_nascimento; ?>" required
                                placeholder="dd/mm/aaaa" maxlength="10" />
                            <br /> <br />

                            <label for="data_inicio" class="title-input"> data de inicio: <span class="asterisco"> *
                                </span> </label>
                            <br /> <input type="text" name="data_inicio" id="data_inicio" class="inedition"
                                autocomplete="off" value="<?php echo $data_inicio; ?>" required placeholder="dd/mm/aaaa"
                                maxlength="10" />
                            <br /><br />
                            ...
                            <br /> <input type="text" name="remuneracao" id="Remuneração" class="inedition"
                                autocomplete="off" value="Não Definido" placeholder="Nâo Necessário" />
                            <br /><br />
                            <label for="nivel_atual" class="title-input"> nível atual: </label>
                            <br /> <input type="text" name="nivel_atual" id="nivel_atual" class="inedition"
                                autocomplete="off" value="Não definido" placeholder="Não Necessário" />
                            <br /><br />
                        </div>
                    </div>
            </div>
        </div>
        <button type="submit" class="submit-edit" name="enviar" value="editado" onclick="return validarSenha()"> enviar
        </button>
        </form>
    </div>
    <div class="footer">
        <div class="footer-info">
            <img src="https://tinypic.host/images/2023/03/16/Frontall-Staffingcolorido.png"
                alt="Frontall-Staffingcolorido.png" class="footer-logo" />
            <span>
        ...
        <div class="footer-icones">
            ...
            <a href="https://instagram.com/frontall_usa/" target="_blank" rel="noopener noreferrer">
                <img src="https://tinypic.host/images/2023/03/16/logoinstacinza.png" alt="logoinstacinza.png"
                    class="logo-redes" />
            </a>
            <a href="https://m.facebook.com/profile.php?id=100063876277619" target="_blank" rel="noopener noreferrer">
                <img src="https://tinypic.host/images/2023/03/16/logofacecinza.png" alt="logofacecinza.png"
                    class="logo-redes" />
            </a>
            <a href="https://www.frontallusa.com/" target="_blank" rel="noopener noreferrer">
                <img src="https://tinypic.host/images/2023/03/16/logo_redes.png" alt="logo_redes.png"
                    class="logo-redes" />
            </a>
        </div>
    </div>
    <script src="js/edicaoFuncoes.js"></script>
