        ...
        <div class="content-log-1">
            ...
            <div class="content-log-2">
                <form class="forms" action="php/select_logado.php" method="POST" autocomplete="off">
                    ...
                    <input type="email" name="email" id="email" placeholder="nomeexemplo@gmail.com" required
                        autocomplete="off" class="inlogin" />
                    <br />
                    ...
                    <div class="caixa-mostrar-senha">
                        ...
                        <span class="mostrar-senha"> <input type="checkbox" onclick="mostrarOcultarSenha()"
                                class="inlogin"> </span>
                        <br />
                    </div>
